...
<div class="box-body">
  <div class="row">
	<div class="col-md-12">
	  <form id="frm" method="post" class="form-horizontal" action="<?php echo site_url('barang/save'); ?>" enctype="multipart/form-data">
		<div class="box-body">
			<div class="form-group">
				<label class="control-label col-sm-2" for="id_barang">Kode Barang</label>
				<div class="col-sm-7">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
				  <input type="text" class="form-control" id="harga_pokok" name="harga_pokok" placeholder="Harga Pokok" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="harga_jual">Harga Jual</label>
				<div class="col-sm-7">
				  <input type="text" class="form-control" id="harga_jual" name="harga_jual" placeholder="Harga Jual" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="stok_awal">Stok Awal</label>
				<div class="col-sm-7">
				  <input type="text" class="form-control" id="stok_awal" name="stok_awal" placeholder="Stok Awal" required>
				</div>
			</div>
			<div class="form-group">
